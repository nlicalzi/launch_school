...
* Latency has a big impact on the performance of networked applications. As developers and software engineers we need to be aware of this impact and try to mitigate it with various optimizations.

* In building networked applications, there are tools and techniques available that work around or go beyond the limitations of basic HTTP request-response functionality.

* For certain use cases a P2P architecture may be more appropriate than a client-server architecture.
